...
os.system("start /wait cmd /c alter session set '_oracle_scrip'=TRUE; ")
...
#criando usuario
os.system("start /wait cmd /c create user " +  vUsuario + ";")
os.system("start /wait cmd /c profile 'DEFAULT' ")
os.system("start /wait cmd /c identified by 'DADOS'' ")
os.system("start /wait cmd /c default tablespace 'DADOS'  ")
os.system("start /wait cmd /c temporary tablespace 'TEMPO' ")
os.system("start /wait cmd /c quota unlimited on DADOS ")
os.system("start /wait cmd /c quota unlimited on INDICES ")
os.system("start /wait cmd /c account unlock; ")
