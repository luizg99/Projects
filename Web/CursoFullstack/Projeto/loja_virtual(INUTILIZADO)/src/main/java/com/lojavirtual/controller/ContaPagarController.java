...
public class ContaPagarController {
	...
	@PostMapping(value = "**/salvarContaPagar") // ** -> SERVE PRA IGNORAR O RESTANTE DA URL
	...
	public ResponseEntity<String> deleteContaPagar(@RequestBody ContaPagarModel contaPagarModel) {
		contaPagarRepository.deleteById(contaPagarModel.getId());
