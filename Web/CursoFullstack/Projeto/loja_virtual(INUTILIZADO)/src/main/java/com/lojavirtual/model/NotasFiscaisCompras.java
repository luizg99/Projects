...
public class NotasFiscaisCompras implements Serializable{
    ...
    private ContaPagarModel ContasPagar;    
    
    @ManyToOne(targetEntity = Pessoas.class)
    @JoinColumn(name = "empresa_id", nullable = false, 
    foreignKey = @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "FK_NOTAS_FIS_COMPRAS_EMP_ID"))
	...
	public ContaPagarModel getContasPagar() {
		return ContasPagar;
	}
	...
	public void setContasPagar(ContaPagarModel contasPagar) {
