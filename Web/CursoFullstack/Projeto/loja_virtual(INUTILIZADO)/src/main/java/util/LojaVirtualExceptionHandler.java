...
import  com.lojavirtual.controller.dto.JSONErroDTO;
...
public class LojaVirtualExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleExceptionCustom (ExceptionMentoriaJava ex) {
		...
		JSONErroDTO objetoErroDTO = new JSONErroDTO();
	...
	protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body,	HttpHeaders headers, HttpStatusCode statusCode, WebRequest request) {
		...
		objetoErroDTO.setCode(statusCode.value() + " ==> " );		
		...
		/*try {
			...
			serviceSendEmail.enviarEmailHtml("Erro na loja virtual", ExceptionUtils.getStackTrace(ex), "alex.fernando.egidio@gmail.com");			
