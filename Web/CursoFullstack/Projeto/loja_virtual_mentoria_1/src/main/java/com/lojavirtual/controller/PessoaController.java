...
public class PessoaController {
	...
	public ResponseEntity<PessoaJuridicaModel> salvarPessoaJuridica(@RequestBody @Valid PessoaJuridicaModel pessoaJuridica) throws ExceptionMentoriaJava {
		...
		if (pessoaJuridica.getId() == null && pessoaJuridicaRepository.existeInscEstadualCadastrado(pessoaJuridica.getInscricaoEstadual()) != null) {
			throw new ExceptionMentoriaJava("Já existe pessoa cadastrada com a seguinte Inscrição estadual: " + pessoaJuridica.getInscricaoEstadual());
		}
